  ...
  return (
    ...
    <div className="w-screen h-[60px] fixed bg-customGray flex flex-row justify-between items-center px-[60px] z-10">
      ...
      <div className=" flex flex-row items-center justify-between">
        ...
        <p className="font-bold text-[20px]  text-orange-700 hidden sm:hidden md:inline lg:inline">
          Admin
        </p>
      </div>
      <input
    ...
    <div className="w-[20%] h-[700px] fixed top-[63px] bg-customGray hidden sm:hidden md:hidden lg:inline">
      <ul className=" mt-[50px]">
        <li className={`flex flex-row items-center ml-6 mb-6 pl-2 py-2 text-gray-600 hover:bg-orange-700  cursor-pointer hover:text-white ${activeItem === 0 ? '  bg-orange-700    ' : ''}`}
          onClick={() => handleItemClick(0)}
        >
          <NavLink to={props.home} className="flex flex-row items-center">
            <FontAwesomeIcon icon={faScrewdriverWrench } className={` ${activeItem === 0 ? ' text-white   ' : ''}`} />
            <p className={` ml-4 ${activeItem === 0 ? ' text-white   ' : ''}`}>DashBoard</p>
          </NavLink>

        </li>
        <li className={`flex flex-row items-center ml-6 mb-6 pl-2 py-2 text-gray-600 hover:bg-orange-700  cursor-pointer hover:text-white ${activeItem === 1 ? 'bg-orange-700  text-white' : ''}`}
        ...
        <li className={`flex flex-row items-center ml-6 mb-6 pl-2 py-2 text-gray-600 hover:bg-orange-700  cursor-pointer hover:text-white ${activeItem === 5 ? 'bg-orange-700  text-white' : ''}`}
