        ...
        <div className='w-full sm:w-full md:w-full lg:w-[80%] h-auto sm:ml-2 lg:ml-[21%] mt-[63px] flex flex-col'>
            {
                loading ? (
                    ...
                    <div className='w-full flex flex-col '>
                        <h1 className='text-[40px] my-5 font-bold  text-gray-500' >Rental Operations you made :</h1>
                        <div className='w-full flex flex-col items-center'>
                            <div className=' w-full lg:w-[80%] h-auto p-4 flex flex-col border-[1px] border-green-600 bg-green-100 rounded-xl mb-3' >
                                <div className='w-full h-[50px] flex flex-row justify-between'>
                                    ...
                                    <div className='w-auto flex flex-row items-center bg-[#02D4DF] px-2 text-white rounded-lg'>
