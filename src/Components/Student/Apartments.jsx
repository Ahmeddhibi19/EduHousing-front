...
const Apartments = () => {
    ...
    const [serverResponseOnTop, setServerResponseOnTop] = useState(false);
        ...
        <div className=' w-full sm:w-full md:w-full lg:w-[80%] h-auto sm:ml-2 lg:ml-[20%] mt-[63px] '>
            {
                loading ? (
                    ...
                    <div className='w-full flex flex-col justify-center'>
                        <div className='w-full sm:w-full md:w-full  h-auto sticky overflow-y-auto'>
                            <div className=' w-full h-auto p-4 flex flex-col border-[1px] border-b-gray-600 bg-customGray' >
                                <div className='w-full h-[50px] flex flex-row justify-between'>
                                    ...
                                    <div className='w-[50px] h-[50px]'>
                                        {
                                            alReadyFav ? (
                                                <FontAwesomeIcon icon={solidStar} onClick={() => handleFav()} className='cursor-pointer' title='al ready added to favourits ... click to remove' />
                                            ) : (
                                                <FontAwesomeIcon icon={regularStar} onClick={() => handleFav()} className='cursor-pointer' title='add to favourites' />
                                            )
                                        }
                                                ...
                                                return (
                                                    <SplideSlide key={item.id}>
                                                        <div className='rounded-3xl  my-7 bg-customGray'>
                                                            ...
                                                            <img src={item} alt={item.title} className='h-auto w-auto object-cover  cursor-pointer hover:scale-105 ease-out duration-300' />
                                                        </div>
                                                    </SplideSlide>
